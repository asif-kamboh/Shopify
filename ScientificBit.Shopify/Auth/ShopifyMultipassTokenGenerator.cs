...
internal sealed class ShopifyMultipassTokenGenerator : IShopifyMultipassTokenGenerator
{
    ...
    public ShopifyMultipassTokenGenerator(string secret, string domain)
    {
    ...
    /// <inheritdoc />
    public string Generate(string customerJson)
    {
